namespace GigHub.Migrations
{
    ...
    public partial class ForTest : DbMigration
    {
        public override void Up()
        {
            ...
            RenameColumn(table: "dbo.Gigs", name: "Artists_Id", newName: "ArtistId");
        ...
        public override void Down()
        {
            ...
            RenameColumn(table: "dbo.Gigs", name: "ArtistId", newName: "Artists_Id");
